...
#define INIT_REG(REG, POS, MODE) ((REG) = ((REG) & ~(0xf << (((POS) % 8) * 4))) | (MODE))

#if defined TARGET_MAPLE_MINI
	#define LED1_CLOCK		RCC_APB2ENR_IOPBEN
	#define LED1_BIT_0		//CLEAR_BIT(GPIOB->CRL, GPIO_CRL_CNF1 | GPIO_CRL_MODE1)
	#define LED1_BIT_1		//CLEAR_BIT(GPIOB->CRL, GPIO_CRL_CNF1_1)
	//#define LED1_MODE		//SET_BIT(GPIOB->CRL, GPIO_CRL_MODE1)
	#define LED1_MODE       INIT_REG(GPIOB->CRL, 1, GPIO_CRL_MODE1)
	#define LED1_ON			WRITE_REG(GPIOB->BSRR, GPIO_BSRR_BS1)
	#define LED1_OFF		WRITE_REG(GPIOB->BSRR, GPIO_BSRR_BR1)
	...
	#define DISC_MODE		INIT_REG(GPIOB->CRH, 9, GPIO_CRH_CNF9_0 | GPIO_CRH_MODE9)
	#define DISC_HIGH		WRITE_REG(GPIOB->BSRR, GPIO_BSRR_BS9)
	#define DISC_LOW		WRITE_REG(GPIOB->BSRR, GPIO_BSRR_BR9)
  ...
  #define LED1_CLOCK		(RCC->APB2ENR |= RCC_APB2ENR_IOPAEN)
	...
	#define LED1_BIT_0
	#define LED1_BIT_1
	#define LED1_MODE       INIT_REG(GPIOA->CRH, 15, GPIO_CRH_MODE15)
	#define LED1_ON			WRITE_REG(GPIOA->BSRR, GPIO_BSRR_BS15)
	#define LED1_OFF		WRITE_REG(GPIOA->BSRR, GPIO_BSRR_BR15)

	#define DISC_CLOCK		RCC_APB2ENR_IOPCEN
	#define DISC_BIT_0
	#define DISC_BIT_1
	#define DISC_MODE		INIT_REG(GPIOC->CRH, 13, GPIO_CRH_CNF13_0 | GPIO_CRH_MODE13)
	...
	#define BOOT_BIT_0  INIT_REG(GPIOA->CRL, 2, GPIO_CRL_CNF2_1)
	#define BOOT_BIT_1
	#define BOOT_SETUP  WRITE_REG(GPIOA->BSRR, GPIO_BSRR_BS2)
	#else
	// No button
	#define CHECK_BOOT 0
	#endif
	...
	#define PAGE_SIZE 2048
	#endif
#elif defined TARGET_BTT_SKR_MINI_E3_2POINT0
	#define LED1_CLOCK		RCC_APB2ENR_IOPAEN
	#define LED1_BIT_0
	#define LED1_BIT_1
	#define LED1_MODE       INIT_REG(GPIOA->CRH, 13, GPIO_CRH_MODE13)
